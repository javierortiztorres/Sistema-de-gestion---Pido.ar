...
<div class="row">
    <div class="col-md-8 order-md-1">
        <form action="<?= site_url('clients/update/' . $client['id']) ?>" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="type" name="type" required>
                    <option value="retail" <?= old('type', $client['type']) == 'retail' ? 'selected' : '' ?>>Retail (Consumidor Final)</option>
                    <option value="wholesale" <?= old('type', $client['type']) == 'wholesale' ? 'selected' : '' ?>>Mayorista</option>
                </select>
            </div>
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit">Actualizar Cliente</button>
